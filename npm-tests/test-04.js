...
app.post('/save',(request,reply)=>{
    ...
    const REGEX_FOR_STRIPPING_HTML_TAGS = /( |<([^>]+)>)/ig;
    userInput.firstname = body.firstname.replace(REGEX_FOR_STRIPPING_HTML_TAGS , '');
    userInput.lastname = body.lastname.replace(REGEX_FOR_STRIPPING_HTML_TAGS , '');
